...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new com.luiz.bookstore.service.exceptions.
			DataIntegrityViolationException("A Categoria não pode ser deletada, pois contém livros atribuídos a mesma!");
		}
	}
}
